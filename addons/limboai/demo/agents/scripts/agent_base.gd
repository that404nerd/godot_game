...
const MINION_RESOURCE := "res://addons/limboai/demo/agents/03_agent_imp.tscn"

# Projectile resource.
const NinjaStar := preload("res://addons/limboai/demo/agents/ninja_star/ninja_star.tscn")
const Fireball := preload("res://addons/limboai/demo/agents/fireball/fireball.tscn")
