...
const Simple := preload("res://addons/limboai/demo/agents/01_agent_melee_simple.tscn")
const Charger := preload("res://addons/limboai/demo/agents/02_agent_charger.tscn")
const Imp := preload("res://addons/limboai/demo/agents/03_agent_imp.tscn")
const Skirmisher := preload("res://addons/limboai/demo/agents/04_agent_skirmisher.tscn")
const Ranged := preload("res://addons/limboai/demo/agents/05_agent_ranged.tscn")
const Combo := preload("res://addons/limboai/demo/agents/06_agent_melee_combo.tscn")
const Nuanced := preload("res://addons/limboai/demo/agents/07_agent_melee_nuanced.tscn")
const Demon := preload("res://addons/limboai/demo/agents/08_agent_demon.tscn")
const Summoner := preload("res://addons/limboai/demo/agents/09_agent_summoner.tscn")
...
func _on_switch_to_showcase_pressed() -> void:
	get_tree().change_scene_to_file("res://addons/limboai/demo/scenes/showcase.tscn")
