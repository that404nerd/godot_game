...
void CameraController::_process(double delta) 
{
    ...
    m_PlayerController->GetCameraAnchor()->set_transform(pitchTransform);
    ...
    set_global_transform(m_PlayerController->GetCameraAnchor()->get_global_transform_interpolated());
