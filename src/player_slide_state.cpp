...
void PlayerSlideState::_on_slide_finished()
{
    ...
    m_CrouchTween->tween_property(m_PlayerInst->get_player_head(), "position:y", m_OriginalHeadPosition.y, 0.2f); // Use this to restore crouch position to original position when cancelling slide
